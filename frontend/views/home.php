...
<head>
    ...
    <meta name="title" content="Welcome to the North">
    <meta name="description" content="Aplicación que permite al usuario organizar su viaje en coche por el norte de España de la manera más cómoda y rápida posible">
    ...
    <link rel="stylesheet" href="views/css/beginning.css">

</head>

<body>
    <?php
    include "modules/beginning.php";
    ?>


    <script src="views/js/plugins/jquery.min.js"></script>
    <script src="views/js/header.js"></script>
    <script src="views/js/beginning.js"></script>
</body>
